...
shader_set_uniform_f(shader_get_uniform(model_surface_render,"cull_mode"),struct.cull_direction);
shader_set_uniform_f(shader_get_uniform(model_surface_render,"mrt"),0);
